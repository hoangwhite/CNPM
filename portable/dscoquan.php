...
<div>
   ...
   <div style="float:left; line-height:30px; margin:5px;"><img src="css/img/muiten.png" /></div>
    <div class="chimuc"><a href="index.php?active=danhmuc&pages=dscq" style="text-decoration: none; color:#000;">Quản lý cơ quan</a></div>
</div>
<div class="page_div" style="width:960px;height:600px;overflow:auto;">
	<center><div class="mndanhmuc">DANH SÁCH CƠ QUAN</div></center>
    <div id="loading"></div>
    <div><a href='?active=danhmuc&pages=them-co-quan'><img src='css/img/add.png' alt='Thêm'/> Thêm mới</a></div>
