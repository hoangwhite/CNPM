...
<?php
	if(isset($_POST["btnIn"]))
	{
		...
		if($chon == 0)
		{
			header ("location:./report/dsvanbandi.php");
		}
		else if($chon ==1){
			...
			{
				header ("location:./report/theongaykyvanbandi.php?tungay=".$_tungay."&denngay=".$_denngay);
			}
		}
		else if($chon ==2){
			$lvb = $_POST["listLoai"];
			settype($lvb,"int"); 
			header ("location:./report/loaivanbandi.php?lvb=".$lvb);
		}
		else if($chon == 3){
			...
			{
				header ("location:./report/theongaygoivanbandi.php?tungay=".$_tungay."&denngay=".$_denngay);
			}
		}
	}
?>
...
<center>
  <div class="mndanhmuc">VĂN BẢN ĐI</div></center>
